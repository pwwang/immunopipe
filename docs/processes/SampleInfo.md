...
`TCRData`/`BCRData` columns are not shown in the report.<br />
...
this process can still be used in the statistics and plots in the report.<br />
...
- `infile` *(`required`)*:
    ...
    * RNAData: The directory for single-cell RNA data for this sample.<br />
    ...
    [`SeuratDisk::LoadLoom()`](https://rdrr.io/github/mojaveazure/seurat-disk/man/LoadLoom.html).<br />
